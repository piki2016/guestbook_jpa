...
public class UserController {
	...
	public String join(@ModelAttribute("user") User user, Model model) throws Exception {
	...
	@Transactional
	public String join(@ModelAttribute("user") @Valid User user, BindingResult bindingResult, Model model) throws Exception {
